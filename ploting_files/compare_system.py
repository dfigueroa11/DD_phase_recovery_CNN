...
def make_plots(paths_in, path_out):
    all_data = []
    ...
    for j, (lr, ax) in enumerate(zip(lr_list, axs.flat)):
        ...
        ax.legend([line1, line2], ['thick CNN', 'lang CNN' ], loc='lower left', bbox_to_anchor=(0.3, 0))
        ax.set_xlabel("SNR [dB]")
        ax.set_ylabel("SER")
        ax.set_ylim((1e-5,1))
        ax.grid(True)
    fig.savefig(f'{path_out}/sweep_SNR_1.pdf')
    plt.close()
    ...
    for j, (llink, ax) in enumerate(zip(Llink_list, axs.flat)):
        ...
        line1 = Line2D([1],[1], linestyle='-',color='0.3')
        line2 = Line2D([1],[1], linestyle='--',color='0.3')
        ax.legend([line1, line2], ['thick CNN', 'lang CNN' ], loc='lower left', bbox_to_anchor=(0.38, 0))
        ax.set_xlabel("SNR [dB]")
        ax.set_ylabel("SER")
        ax.set_ylim((1e-5,1))
        ax.grid(True)
    fig.savefig(f'{path_out}/sweep_SNR_2.pdf')
    plt.close()
    ...
    for j, (lr, ax) in enumerate(zip(lr_list, axs.flat)):
        ...
        line1 = Line2D([1],[1], linestyle='-',color='0.3')
        line2 = Line2D([1],[1], linestyle='--',color='0.3')
        ax.legend([line1, line2], ['thick CNN', 'lang CNN' ], loc='lower left', bbox_to_anchor=(0.29, 0))
        ax.set_xlabel("link length [km]")
        ax.set_ylabel("SER")
        ax.set_ylim((1e-5,1))
        ax.grid(True)
    fig.savefig(f'{path_out}/sweep_Llink_1.pdf')
    plt.close()
    ...
    for j, (snr, ax) in enumerate(zip(SNR_list, axs.flat)):
        ...
        line1 = Line2D([1],[1], linestyle='-',color='0.3')
        line2 = Line2D([1],[1], linestyle='--',color='0.3')
        ax.legend([line1, line2], ['thick CNN', 'lang CNN' ], loc='lower left', bbox_to_anchor=(0.23, 0))
        ax.set_xlabel("link length [km]")
        ax.set_ylabel("SER")
        ax.set_ylim((1e-5,1))
        ax.grid(True)
    fig.savefig(f'{path_out}/sweep_Llink_2.pdf')
    plt.close()
    ...
    for j, (snr, ax) in enumerate(zip(SNR_list, axs.flat)):
        ...
        line1 = Line2D([1],[1], linestyle='-',color='0.3')
        line2 = Line2D([1],[1], linestyle='--',color='0.3')
        ax.legend([line1, line2], ['thick CNN', 'lang CNN' ], loc='lower left', bbox_to_anchor=(0.47, 0))
        ax.set_xlabel("learning rate")
        ax.set_ylabel("SER")
        ax.set_ylim((1e-5,1))
        ax.grid(True)
    fig.savefig(f'{path_out}/sweep_lr_1.pdf')
    plt.close()
    ...
    for j, (llink, ax) in enumerate(zip(Llink_list, axs.flat)):
        ...
        line1 = Line2D([1],[1], linestyle='-',color='0.3')
        line2 = Line2D([1],[1], linestyle='--',color='0.3')
        ax.legend([line1, line2], ['thick CNN', 'lang CNN' ], loc='lower left', bbox_to_anchor=(0.44, 0))
        ax.set_xlabel("learning rate")
        ax.set_ylabel("SER")
        ax.set_ylim((1e-5,1))
        ax.grid(True)
    fig.savefig(f'{path_out}/sweep_lr_2.pdf')
    plt.close()

folders = ["phase_diff_mag_in/ASK4",
            "phase_diff_mag_in/DDQAM8",
            "odd_samp_phase_in/ASK4",
            "phase_diff/ASK2",
            "phase_diff/ASK4",
            "phase_diff/QAM4",
            "phase_diff/DDQAM4",
...
source_folders = ["/Users/diegofigueroa/Desktop/results_hist", "/Users/diegofigueroa/Desktop/KIT/HiWi/results_SNR_histogram"]
dest_folder = "/Users/diegofigueroa/Desktop/results_comp"

for folder in folders:
    make_plots([f"{source_folders[0]}/{folder}", f"{source_folders[1]}/{folder}"], f"{dest_folder}/{folder}")
